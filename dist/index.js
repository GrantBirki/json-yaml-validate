...
const discriminator_1 = __nccwpck_require__(8886);
const json_schema_2019_09_1 = __nccwpck_require__(5375);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const metaSchema = __nccwpck_require__(8138);
const applicator = __nccwpck_require__(4908);
const content = __nccwpck_require__(958);
const core = __nccwpck_require__(58);
const format = __nccwpck_require__(6534);
const metadata = __nccwpck_require__(711);
const validation = __nccwpck_require__(8030);
const META_SUPPORT_DATA = ["/properties"];
...
(__nccwpck_require__(9023).inherits)(Command, EventEmitter);
...
var common              = __nccwpck_require__(1825);
...
var _error2 = __nccwpck_require__(2255);
...
var _componentType = __nccwpck_require__(3862);

var _componentType2 = _interopRequireDefault(_componentType);

var _eivindfjeldstadDot = __nccwpck_require__(5656);

var _eivindfjeldstadDot2 = _interopRequireDefault(_eivindfjeldstadDot);

var _typecast = __nccwpck_require__(1351);

var _typecast2 = _interopRequireDefault(_typecast);

var _property = __nccwpck_require__(9016);

var _property2 = _interopRequireDefault(_property);

var _messages = __nccwpck_require__(9485);

var _messages2 = _interopRequireDefault(_messages);

var _validators = __nccwpck_require__(4206);

var _validators2 = _interopRequireDefault(_validators);

var _error = __nccwpck_require__(2255);

var _error2 = _interopRequireDefault(_error);

var _utils = __nccwpck_require__(864);
...
const program = __nccwpck_require__(3338)
const pkg = __nccwpck_require__(7614)
const validateSchema = __nccwpck_require__(771)
...
const logger = __nccwpck_require__(6332)
const schemaBuilder = __nccwpck_require__(1095)
const utils = __nccwpck_require__(5487)
const printErrors  = __nccwpck_require__(975)

module.exports = { logger, schemaBuilder, utils, printErrors }
...
const chalk = __nccwpck_require__(1033)
...
const { loadContent } = __nccwpck_require__(5487)
...
const colorConvert = __nccwpck_require__(1239);
...
const escapeStringRegexp = __nccwpck_require__(925);
const ansiStyles = __nccwpck_require__(6190);
const stdoutColor = (__nccwpck_require__(2528).stdout);

const template = __nccwpck_require__(3590);
...
/* MIT license */
var cssKeywords = __nccwpck_require__(8115);
...
var conversions = __nccwpck_require__(5694);
var route = __nccwpck_require__(8978);
...
const hasFlag = __nccwpck_require__(6311);
...
const fs = __nccwpck_require__(9896)
const Schema = __nccwpck_require__(9298)
const { logger, schemaBuilder, utils, printErrors } = __nccwpck_require__(9886)
...
const validateSchema =  (targetObject, options = {}) => {
  ...
  try {
    ...
    let inputSchema = options.schema || options.schemaPath || __nccwpck_require__.ab + "schema.json"
...
function getBooleanInput(name, options = {}) {
    ...
    throw new TypeError(`Input does not meet YAML 1.2 boolean format: ${name}=${value}`);
}
...
const nativeCore = {
    ...
    setOutput(name, value) {
        ...
        if (outputPath) {
            ...
            (0,external_node_fs_.appendFileSync)(outputPath, `${name}<<${delimiter}\n${value}\n${delimiter}\n`);
            return;
        }
...
/* harmony import */ var ignore__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(298);
/* harmony import */ var ignore__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__nccwpck_require__.n(ignore__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _actions_core_js__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(1499);
...
class Exclude {
    ...
    required;
    constructor() {
        this.path = _actions_core_js__WEBPACK_IMPORTED_MODULE_2__/* .core */ .I.getInput('exclude_file');
        this.required = _actions_core_js__WEBPACK_IMPORTED_MODULE_2__/* .core */ .I.getBooleanInput('exclude_file_required');
        this.gitTrackedOnly = _actions_core_js__WEBPACK_IMPORTED_MODULE_2__/* .core */ .I.getBooleanInput('use_gitignore');
        this.ignore = ignore__WEBPACK_IMPORTED_MODULE_1___default()();
        if (this.path && this.path !== '') {
            _actions_core_js__WEBPACK_IMPORTED_MODULE_2__/* .core */ .I.debug(`loading exclude_file: ${this.path}`);
            try {
                this.ignore.add((0,node_fs__WEBPACK_IMPORTED_MODULE_0__.readFileSync)(this.path, 'utf8').toString());
                _actions_core_js__WEBPACK_IMPORTED_MODULE_2__/* .core */ .I.debug(`loaded custom exclude patterns`);
            }
            catch (error) {
                if (this.required === true) {
                    _actions_core_js__WEBPACK_IMPORTED_MODULE_2__/* .core */ .I.setFailed(`error reading exclude_file: ${this.path}`);
                    throw new Error(toError(error).toString(), { cause: error });
                }
                _actions_core_js__WEBPACK_IMPORTED_MODULE_2__/* .core */ .I.info(`exclude_file was not found, but it is not required - OK`);
            }
        }
        else {
            _actions_core_js__WEBPACK_IMPORTED_MODULE_2__/* .core */ .I.debug(`exclude_file was not provided - OK`);
        }
        if (this.gitTrackedOnly) {
            _actions_core_js__WEBPACK_IMPORTED_MODULE_2__/* .core */ .I.debug(`use_gitignore: ${this.gitTrackedOnly}`);
            const gitIgnorePath = _actions_core_js__WEBPACK_IMPORTED_MODULE_2__/* .core */ .I.getInput('git_ignore_path');
            _actions_core_js__WEBPACK_IMPORTED_MODULE_2__/* .core */ .I.debug(`loading .gitignore file from path: ${gitIgnorePath}`);
            try {
                this.ignore.add((0,node_fs__WEBPACK_IMPORTED_MODULE_0__.readFileSync)(gitIgnorePath).toString());
            }
            catch (error) {
                _actions_core_js__WEBPACK_IMPORTED_MODULE_2__/* .core */ .I.warning(`error reading .gitignore file: ${error}`);
            }
        }
    }
    isExcluded(file) {
...
// EXPORTS
__nccwpck_require__.d(__webpack_exports__, {
  n: () => (/* binding */ discoverFilesByExtension)
});
...
;// CONCATENATED MODULE: ./src/functions/file-discovery.ts


function normalizePath(filePath) {
    return filePath.split(external_node_path_namespaceObject.sep).join('/');
}
function discoverFilesByExtension(baseDir, extensions, useDotMatch) {
    const files = [];
    function walk(directory) {
        const entries = (0,external_node_fs_.readdirSync)(directory, { withFileTypes: true });
        for (const entry of entries) {
            if (!useDotMatch && entry.name.startsWith('.')) {
                continue;
            }
            const fullPath = (0,external_node_path_namespaceObject.join)(directory, entry.name);
...
/* harmony import */ var _file_discovery_js__WEBPACK_IMPORTED_MODULE_5__ = __nccwpck_require__(3445);
...
async function schema(jsonSchema) {
    ...
    _actions_core_js__WEBPACK_IMPORTED_MODULE_4__/* .core */ .I
        ...
        if (!CUSTOM_FORMAT_REGEX.test(customFormat.trim())) {
            throw new Error(`Invalid ajv_custom_regexp_formats format: "${customFormat}" is not in expected format "key=regex"`);
        }
...
/* harmony export */ __nccwpck_require__.d(__webpack_exports__, {
/* harmony export */   I: () => (/* binding */ processResults)
/* harmony export */ });
/* harmony import */ var node_fs__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(3024);
/* harmony import */ var node_fs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__nccwpck_require__.n(node_fs__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _actions_core_js__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(1499);
...
async function checkResults(results, type) {
    ...
    if (results.success === true) {
        _actions_core_js__WEBPACK_IMPORTED_MODULE_1__/* .core */ .I.info(`✅ all ${results.passed} detected ${type} files are valid`);
        return true;
    }
    _actions_core_js__WEBPACK_IMPORTED_MODULE_1__/* .core */ .I.info(`${type} Validation Results:\n  - Passed: ${results.passed}\n  - Failed: ${results.failed}\n  - Skipped: ${results.skipped}\n  - Violations: ${JSON.stringify(results.violations, null, 2)}`);
    _actions_core_js__WEBPACK_IMPORTED_MODULE_1__/* .core */ .I.error(`❌ ${results.failed} ${type} files failed validation`);
    return false;
}
...
function getPullRequestContext() {
    ...
    const payload = JSON.parse((0,node_fs__WEBPACK_IMPORTED_MODULE_0__.readFileSync)(process.env.GITHUB_EVENT_PATH, 'utf8'));
    if (!payload?.pull_request) {
        return null;
    }
    const [owner, repo] = (process.env.GITHUB_REPOSITORY || payload.repository.full_name).split('/');
    return {
        owner,
        repo,
...
async function createPullRequestComment(token, pullRequestContext, body) {
    const response = await fetch(`${process.env.GITHUB_API_URL || DEFAULT_GITHUB_API_URL}/repos/${pullRequestContext.owner}/${pullRequestContext.repo}/issues/${pullRequestContext.issueNumber}/comments`, {
        method: 'POST',
        headers: {
...
function applyMode() {
    if (_actions_core_js__WEBPACK_IMPORTED_MODULE_1__/* .core */ .I.getInput('mode') === MODE_FAIL) {
        _actions_core_js__WEBPACK_IMPORTED_MODULE_1__/* .core */ .I.setFailed('❌ JSON or YAML files failed validation');
    }
    else if (_actions_core_js__WEBPACK_IMPORTED_MODULE_1__/* .core */ .I.getInput('mode') === MODE_WARN) {
        _actions_core_js__WEBPACK_IMPORTED_MODULE_1__/* .core */ .I.warning('mode is set to "warn" - this action will not fail');
        _actions_core_js__WEBPACK_IMPORTED_MODULE_1__/* .core */ .I.error('❌ JSON or YAML files failed validation');
    }
    else {
        _actions_core_js__WEBPACK_IMPORTED_MODULE_1__/* .core */ .I.warning(`unrecognized mode: ${_actions_core_js__WEBPACK_IMPORTED_MODULE_1__/* .core */ .I.getInput('mode')}`);
        _actions_core_js__WEBPACK_IMPORTED_MODULE_1__/* .core */ .I.setFailed('❌ JSON or YAML files failed validation');
    }
    return false;
}
...
/* harmony export */ __nccwpck_require__.d(__webpack_exports__, {
/* harmony export */   _: () => (/* binding */ yamlValidator)
/* harmony export */ });
/* harmony import */ var yaml_schema_validator__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(3146);
/* harmony import */ var yaml_schema_validator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__nccwpck_require__.n(yaml_schema_validator__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var yaml__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(8815);
/* harmony import */ var _actions_core_js__WEBPACK_IMPORTED_MODULE_3__ = __nccwpck_require__(1499);
/* harmony import */ var _file_discovery_js__WEBPACK_IMPORTED_MODULE_4__ = __nccwpck_require__(3445);
...
function discoverExplicitFiles(patterns) {
    const files = [];
    for (const pattern of patterns) {
        files.push(...(0,node_fs__WEBPACK_IMPORTED_MODULE_1__.globSync)(pattern));
    }
    return files;
}
...
async function yamlValidator(exclude) {
    const baseDir = _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.getInput('base_dir');
    const jsonExtension = _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.getInput('json_extension');
    const yamlExtension = _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.getInput('yaml_extension');
    const yamlExtensionShort = _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.getInput('yaml_extension_short');
    const yamlSchema = _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.getInput('yaml_schema');
    const yamlExcludeRegex = _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.getInput('yaml_exclude_regex');
    const yamlAsJson = _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.getBooleanInput('yaml_as_json');
    const useDotMatch = _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.getBooleanInput('use_dot_match');
    const allowMultipleDocuments = _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.getBooleanInput('allow_multiple_documents');
    const patterns = _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.getMultilineInput('files').filter(Boolean);
    let files = discoverExplicitFiles(patterns);
    const baseDirSanitized = baseDir.replace(/\/$/, '');
    ...
    _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.debug(`yaml - using baseDir: ${baseDirSanitized}`);
    _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.debug(`yaml - using glob: ${glob}`);
    if (files.length > 0) {
        _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.debug(`using files: ${files.join(', ')}`);
    }
    else {
        _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.debug(`using baseDir: ${baseDirSanitized}`);
        _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.debug(`using glob: ${glob}`);
        files = (0,_file_discovery_js__WEBPACK_IMPORTED_MODULE_4__/* .discoverFilesByExtension */ .n)(baseDirSanitized, [yamlExtension, yamlExtensionShort], useDotMatch);
    }
    const processedFiles = new Set();
    for (const fullPath of files) {
        _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.debug(`found file: ${fullPath}`);
        if (yamlSchema !== '' && fullPath === yamlSchema) {
            _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.debug(`skipping yaml schema file: ${fullPath}`);
            continue;
        }
        const isJsonFile = jsonExtension && fullPath.endsWith(jsonExtension);
        if (yamlAsJson === false && isJsonFile) {
            _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.debug(`the yaml-validator found a json file so it will be skipped here: '${fullPath}'`);
            continue;
        }
        if (yamlAsJson) {
            _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.debug(`skipping yaml since it should be treated as json: ${fullPath}`);
            result.skipped++;
            continue;
        }
        if (skipRegex !== null && skipRegex.test(fullPath)) {
            _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.info(`skipping due to exclude match: ${fullPath}`);
            result.skipped++;
            continue;
        }
        if (exclude.isExcluded(fullPath)) {
        ...
        if (processedFiles.has(fullPath)) {
            _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.debug(`skipping duplicate file: ${fullPath}`);
            continue;
        }
        let multipleDocuments = false;
        try {
            if (allowMultipleDocuments) {
                const documents = (0,yaml__WEBPACK_IMPORTED_MODULE_2__/* .parseAllDocuments */ .hR)((0,node_fs__WEBPACK_IMPORTED_MODULE_1__.readFileSync)(fullPath, 'utf8'));
                for (const doc of documents) {
                    if (doc.errors.length > 0) {
                        throw doc.errors[0];
                    }
                    (0,yaml__WEBPACK_IMPORTED_MODULE_2__/* .parse */ .qg)(doc.toString());
                }
                _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.info(`multiple documents found in file: ${fullPath}`);
                multipleDocuments = true;
            }
            else {
                (0,yaml__WEBPACK_IMPORTED_MODULE_2__/* .parse */ .qg)((0,node_fs__WEBPACK_IMPORTED_MODULE_1__.readFileSync)(fullPath, 'utf8'));
            }
        }
        catch (error) {
            _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.error(`❌ failed to parse YAML file: ${fullPath}`);
            result.success = false;
            result.failed++;
            result.violations.push({
                file: fullPath,
        ...
        if (hasNoSchema || multipleDocuments) {
            result.passed++;
            _actions_core_js__WEBPACK_IMPORTED_MODULE_3__/* .core */ .I.info(`${fullPath} is valid`);
            continue;
        }
        const schemaErrors = yaml_schema_validator__WEBPACK_IMPORTED_MODULE_0___default()(`${fullPath}`, {
            schema: yamlSchema,
            logLevel: 'none'
        });
...
/* harmony import */ var _functions_yaml_validator_js__WEBPACK_IMPORTED_MODULE_3__ = __nccwpck_require__(6813);




const defaultDependencies = {
    Exclude: _functions_exclude_js__WEBPACK_IMPORTED_MODULE_0__/* .Exclude */ .n,
    jsonValidator: _functions_json_validator_js__WEBPACK_IMPORTED_MODULE_1__/* .jsonValidator */ .p,
    processResults: _functions_process_results_js__WEBPACK_IMPORTED_MODULE_2__/* .processResults */ .I,
    yamlValidator: _functions_yaml_validator_js__WEBPACK_IMPORTED_MODULE_3__/* .yamlValidator */ ._
};
async function run(dependencies = defaultDependencies) {
    const jsonResults = await dependencies.jsonValidator(new dependencies.Exclude());
    const yamlResults = await dependencies.yamlValidator(new dependencies.Exclude());
...
exports.hR = publicApi.parseAllDocuments;
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://json-schema.org/draft/2019-09/schema","$id":"https://json-schema.org/draft/2019-09/schema","$vocabulary":{"https://json-schema.org/draft/2019-09/vocab/core":true,"https://json-schema.org/draft/2019-09/vocab/applicator":true,"https://json-schema.org/draft/2019-09/vocab/validation":true,"https://json-schema.org/draft/2019-09/vocab/meta-data":true,"https://json-schema.org/draft/2019-09/vocab/format":false,"https://json-schema.org/draft/2019-09/vocab/content":true},"$recursiveAnchor":true,"title":"Core and Validation specifications meta-schema","allOf":[{"$ref":"meta/core"},{"$ref":"meta/applicator"},{"$ref":"meta/validation"},{"$ref":"meta/meta-data"},{"$ref":"meta/format"},{"$ref":"meta/content"}],"type":["object","boolean"],"properties":{"definitions":{"$comment":"While no longer an official keyword as it is replaced by $defs, this keyword is retained in the meta-schema to prevent incompatible extensions as it remains in common use.","type":"object","additionalProperties":{"$recursiveRef":"#"},"default":{}},"dependencies":{"$comment":"\\"dependencies\\" is no longer a keyword, but schema authors should avoid redefining it to facilitate a smooth transition to \\"dependentSchemas\\" and \\"dependentRequired\\"","type":"object","additionalProperties":{"anyOf":[{"$recursiveRef":"#"},{"$ref":"meta/validation#/$defs/stringArray"}]}}}}');
...
module.exports = /*#__PURE__*/JSON.parse('{"name":"yaml-schema-validator","version":"1.2.3","description":"Schema validator for yaml files","author":"Ketan Saxena","license":"MIT","main":"index.js","scripts":{"start":"node index.js","test":"node tests/index.js","validate":"node index.js validate --help","help":"node index.js help"},"repository":{"type":"git","url":"https://github.com/ketanTechracers/schema-validator"},"devDependencies":{"node-dev":"3.1.3","prettier":"^1.10.2"},"dependencies":{"chalk":"^2.4.1","commander":"^2.16.0","js-yaml":"^3.12.0","validate":"^4.4.1"},"keywords":["validation","schema-validate","schema-validator","json-schema","yaml-schema","validate","schema"],"bin":{"schema":"./index.js"}}');
